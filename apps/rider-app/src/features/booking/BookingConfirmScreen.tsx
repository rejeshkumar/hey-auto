    ...
    <View style={styles.container}>
      ...
      >
        ...
        <Polyline
          ...
          strokeColor={colors.map.route} strokeWidth={4}
                ...
                {(['CASH', 'UPI'] as const).map((method) => (
                  ...
                  >
                    <MaterialCommunityIcons
                      ...
                      size={18} color={paymentMethod === method ? colors.white : colors.text}
                    />
...
const styles = StyleSheet.create({
  ...
  map: { flex: 1 },
  backBtn: {
    position: 'absolute', top: 50, left: spacing.base, width: 44, height: 44, borderRadius: 22,
  ...
  bottomSheet: {
    ...
    elevation: 10, shadowColor: colors.black, shadowOffset: { width: 0, height: -3 }, shadowOpacity: 0.15, shadowRadius: 10,
  },
  ...
  fareCard: { backgroundColor: colors.surface, borderRadius: borderRadius.lg, padding: spacing.base, marginBottom: spacing.base },
