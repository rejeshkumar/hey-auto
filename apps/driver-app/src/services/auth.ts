...
export const authApi = {
  sendOtp: (phone: string) =>
    api.post<ApiResponse<SendOtpResponse>>('/auth/send-otp', { phone: normalizePhone(phone), role: 'DRIVER' }),

  verifyOtp: (phone: string, otp: string, deviceId?: string) =>
    api.post<ApiResponse<VerifyOtpResponse>>('/auth/verify-otp', { phone: normalizePhone(phone), otp, role: 'DRIVER', deviceId }),
